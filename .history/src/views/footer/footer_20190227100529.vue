...
<div id="footer">
    <div class="ft-bg">
        <div class="w-ensure mb20">
            <div class="w-main">
                <ul>
                    <li class="col-4">精度为90-96%</li>
                    <li class="col-4">世行项目支持</li>
                    <li class="col-4">定制ET遥感</li>
                    <li class="col-4">节水效果评估</li>
                </ul>
            </div>
        ...
        <div class="ft_main">
            ...
            <div class="ft_txt">
                <p class="ft_contact"> 
                    <span class="ft_phone">服务邮箱: <em>wubf@radi.ac.cn</em></span>
                </p>
            </div>
            <div class="ft_txt">
          <div class="container">
                           ...
                           <div class="footer-link">   
                                <a href="/about/us" target="_blank" title="关于我们">关于我们</a>   
                                 <!--      <a href="/about/job" target="_blank" title="人才招聘">人才招聘</a>--> 
                                        ...
                                        <a href="/about/friendly" target="_blank" title="友情链接">友情链接</a>    </div>  
                             <div class="footer-copyright">     <p>©&nbsp2019&nbspetwatch.cn&nbsp&nbsp京ICP备 12003892号-11</p>    </div> 
                             </div></div>
