<template>
  <div id="header" class="new_header" style="background: url(../../static/images/register/loginBg1.jpg)no-repeat">
    <div class="hd_bar">
    ...
    <div class="hd_main cle">
        ...
        <div class="intro">
            <h1>ETWatch是面向流域规划与管理和农业水管理的实用需求,针对遥感应用而设计的遥感蒸散监测系统</h1>            
        </div>
    </div>
    </div>
</template>
