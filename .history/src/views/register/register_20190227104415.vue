            ...
            <div class="tab-form">
                <form id="register_form" autocomplete="off">
                    ...
                    <div class="form-group marb8">
                        <label>用户名</label>
                        <input id="jsRegUsername" name="account" v-model="username" type="text" placeholder="请输入您的用户名">
                    </div>
                    ...
                    <div class="form-group marb8">
                        <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                        <input id="jsPhoneRegPwd" name="password_m" type="password" v-model="password" placeholder="请输入6-20位密码">
                    </div>
    ...
    methods:{
        isRegister(){
          ...
          .catch(function (error) {
            that.error.email = error.email?error.email[0]:'';
