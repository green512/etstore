            ...
            <ul class="newgoods_fastbuy">
                <li class="prolist-cent clearfix have_num" v-for="item in newopro">
                    ...
                    <div class="prolist-r fl">
                        ...
                        <span class="p-price"><em class="fastbuy_price">￥{{item.shop_price}}元</em><del>原价:￥{{item.market_price}}元/500次</del></span>
                        <a href="" class="p-buy fr ibg">立即订购</a>
...
.p-buy:hover{color: #dae0e6;}
.p-buy{width: 188px; height: 56px; line-height: 56px; color: #000; font-weight:bold; font-size: 18px; text-indent: 78px; background-position: 0 -36px; margin-left: 25px;}
