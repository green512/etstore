        ...
        <li class="item">
            ...
            <ul>
                <li>
                    ...
                    <a :class="{on: current==='receive'}"  @click="toReceive">我的地址</a>
                    <a :class="{on: current==='payment'}"  @click="toPayment">我的账单</a>
                </li>
            </ul>
        </li>
        <li class="item">
            ...
            <ul>
                <li>
                    ...
                    <a :class="{on: current==='message'}" @click="toMessage">我的工单</a>
                </li>
            </ul>
        </li>
    </ul>
